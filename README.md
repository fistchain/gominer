...
Fistchain network.  It supports solo and stratum/pool mining using CUDA and
OpenCL devices.
...
```
go get github.com/fistchain/gominer
cd $GOPATH/src/github.com/fistchain/gominer
cd gominer
...
- Change to the gominer directory
  * If using the Windows Command Prompt:
  ```cd %GOPATH%/src/github.com/fistchian/gominer```
  * If using git-bash
  ```cd $GOPATH/src/github.com/fistchian/gominer```
